...
def infer_paragraph_embeddings_features(data, model, dim):
    ...
    para_vec = model.infer_vector(vec, steps=20, alpha=0.025)

    for i, val in enumerate(para_vec):
        f["par_vec_{}".format(i)] = val
